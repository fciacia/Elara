      ...
      child: Consumer<AppProvider>(
        builder: (context, appProvider, child) {
          return GetMaterialApp(
            ...
            // 🌍 Add translations with dynamic locale
            translations: AppTranslations(),
            locale: Locale(appProvider.getLanguageCode()), // Use AppProvider language
  ...
  ThemeData _buildLightTheme() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
        ...
        surface: AppColors.backgroundLight, // Pure white background
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: AppColors.borderLight, width: 1.5), // Thicker border for better visibility
        ),
  ...
  ThemeData _buildDarkTheme() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSeed(
        ...
        surface: AppColors.backgroundDark, // Purple-tinted dark background
