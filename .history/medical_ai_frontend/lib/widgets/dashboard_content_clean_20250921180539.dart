...
import '../providers/chat_provider_aws.dart' as aws;
...
class _DashboardContentState extends State<DashboardContent> with TickerProviderStateMixin {
  ...
  List<ElaraChatMessage> _elaraMessages = [
    ElaraChatMessage('hello_assist_today'.tr, false),
  ];
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: _buildQuickActionCard(
            'patient_search'.tr,
            'find_patient_records'.tr,
            Icons.search,
            AppColors.doctorRole,
            () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('patient_search_coming_soon'.tr, style: GoogleFonts.inter()),
        ...
        Expanded(
          child: _buildQuickActionCard(
            'emergency_protocol'.tr,
            'quick_access_protocols'.tr,
            Icons.local_hospital,
            AppColors.accent,
            () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('emergency_protocols_accessed'.tr, style: GoogleFonts.inter()),
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('view_all'.tr, style: GoogleFonts.inter(color: AppColors.primary)),
                  ),
                ],
              ),
              const SizedBox(height: 16),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  '${'chat_session'.tr} ${session.id.length > 8 ? session.id.substring(0, 8) : session.id}',
                  style: GoogleFonts.inter(
                    fontSize: 14,
                    fontWeight: FontWeight.w500,
                    color: Colors.white,
                ...
                Text(
                  '${session.messages.length} ${'messages'.tr} • ${_formatTime(session.createdAt)}',
                  style: GoogleFonts.inter(
                    fontSize: 12,
                    color: Colors.white.withValues(alpha: 0.8),
                  ),
          ...
          Row(
            children: [
              ...
              TextButton(
                ...
                child: Text('view_all'.tr, style: GoogleFonts.inter(color: AppColors.secondary)),
              ),
            ],
          ),
          const SizedBox(height: 16),
