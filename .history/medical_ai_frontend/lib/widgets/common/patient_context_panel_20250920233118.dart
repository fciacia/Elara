...
import '../../utils/app_colors.dart';import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';



class PatientContextPanel extends StatefulWidget {import '../../utils/app_colors.dart';import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';
  ...
  const PatientContextPanel({
    ...
    Key? key,class PatientContextPanel extends StatefulWidget {import '../../utils/app_colors.dart';import '../../utils/app_theme.dart';

    required this.patientId,

  }) : super(key: key);  final String patientId;



  @override  import '../common/app_components.dart';
...
class _PatientContextPanelState extends State<PatientContextPanel>    Key? key,class PatientContextPanel extends StatefulWidget {

    with SingleTickerProviderStateMixin {

  late TabController _tabController;    required this.patientId,

  

  @override  }) : super(key: key);  final String patientId;class PatientContextPanel extends StatefulWidget {
  ...
  @override  State<PatientContextPanel> createState() => _PatientContextPanelState();

  void dispose() {

    _tabController.dispose();}  const PatientContextPanel({  
  ...
  @overrideclass _PatientContextPanelState extends State<PatientContextPanel>    Key? key,  const PatientContextPanel({

  Widget build(BuildContext context) {

    return Container(    with SingleTickerProviderStateMixin {

      width: double.infinity,

      height: double.infinity,  late TabController _tabController;    required this.patientId,    Key? key,
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          ...
          left: BorderSide(  @override  }) : super(key: key);    required this.patientId,

            color: Theme.of(context).colorScheme.outline.withValues(alpha: 0.2), 

            width: 1  void initState() {
      ...
      child: Column(    _tabController = TabController(length: 4, vsync: this);

        children: [

          _buildHeader(),  }  @override
          ...
          Expanded(
            ...
            child: TabBarView(  @override  State<PatientContextPanel> createState() => _PatientContextPanelState();  @override

              controller: _tabController,

              children: [  void dispose() {

                _buildOverviewTab(),

                _buildVitalsTab(),    _tabController.dispose();}  State<PatientContextPanel> createState() => _PatientContextPanelState();

                _buildMedicationsTab(),

                _buildNotesTab(),    super.dispose();
  ...
  Widget _buildHeader() {
    ...
    return Container(    return Container(    with SingleTickerProviderStateMixin {class _PatientContextPanelState extends State<PatientContextPanel>
      ...
      decoration: BoxDecoration(      width: double.infinity,
        ...
        border: Border(      height: double.infinity,  late TabController _tabController;    with SingleTickerProviderStateMixin {

          bottom: BorderSide(

            color: Theme.of(context).colorScheme.outline.withValues(alpha: 0.2),       decoration: BoxDecoration(
      ...
      child: Row(
        ...
        children: [          left: BorderSide(  @override  

          Icon(

            MdiIcons.account,            color: Theme.of(context).colorScheme.outline.withValues(alpha: 0.2), 

            size: 20,

            color: AppColors.primary,            width: 1  void initState() {  @override
          ...
          Text(
            ...
            'Patient Context',        ),    super.initState();  void initState() {
  ...
  Widget _buildPatientInfo() {
    ...
    return Container(          _buildTabBar(),  }
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(            child: TabBarView(  @override

          colors: [

            AppColors.primary.withValues(alpha: 0.1),              controller: _tabController,
          ...
          end: Alignment.bottomRight,                _buildOverviewTab(),

        ),

        borderRadius: BorderRadius.circular(12),                _buildVitalsTab(),    _tabController.dispose();  void dispose() {

      ),

      child: Row(                _buildMedicationsTab(),

        children: [

          Container(                _buildNotesTab(),    super.dispose();    _tabController.dispose();
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(            ),  }    super.dispose();
              ...
              borderRadius: BorderRadius.circular(12),    );  @override
            ...
            child: const Center(  }
              ...
              child: Text(
                ...
                'EC',  Widget build(BuildContext context) {  @override

                style: TextStyle(

                  color: Colors.white,  Widget _buildHeader() {

                  fontWeight: FontWeight.w600,

                  fontSize: 16,    return Container(    return Container(  Widget build(BuildContext context) {
          ...
          Expanded(        color: Theme.of(context).colorScheme.surface,
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,        border: Border(      height: double.infinity,      width: 380,

              children: [

                Text(          bottom: BorderSide(

                  'Emily Chen',

                  style: Theme.of(context).textTheme.titleMedium?.copyWith(            color: Theme.of(context).colorScheme.outline.withValues(alpha: 0.2),       decoration: BoxDecoration(      height: double.infinity,

                    color: Theme.of(context).colorScheme.onSurface,

                    fontWeight: FontWeight.w600,            width: 1
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(
                    ...
                    color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.7),      ),        border: Border(        color: AppTheme.surfaceColor,
          ...
          Container(          Icon(
            ...
            decoration: BoxDecoration(            MdiIcons.account,        ),          left: BorderSide(color: AppTheme.dividerColor, width: 1),

              color: Colors.green.withValues(alpha: 0.2),

              borderRadius: BorderRadius.circular(8),            size: 20,
            ...
            child: Text(            color: AppColors.primary,      ),        ),
              ...
              style: Theme.of(context).textTheme.labelSmall?.copyWith(          ),
                ...
                fontWeight: FontWeight.w500,          const SizedBox(width: 8),      child: Column(      ),
  ...
  Widget _buildTabBar() => Container();              color: Theme.of(context).colorScheme.onSurface,

  Widget _buildOverviewTab() => Container();

  Widget _buildVitalsTab() => Container();            ),          _buildPatientInfo(),          _buildHeader(),

  Widget _buildMedicationsTab() => Container();

  Widget _buildNotesTab() => Container();          ),
