...
import '../providers/auth_provider.da  Widget _buildSettingsSection(String title, Widget child, {bool isDarkMode = false}) {
    ...
    return Container(
      ...
      ),mport '../providers/app_provider.dart';
...
class _SettingsPanelState extends State<SettingsPanel> with TickerProviderStateMixin {
  ...
  Color _getTextColor(bool isDarkMode) {
    return isDarkMode ? Colors.white.withValues(alpha: 0.9) : AppColors.textDark;
  }

  Color _getSecondaryTextColor(bool isDarkMode) {
    return isDarkMode ? Colors.white.withValues(alpha: 0.8) : AppColors.textMedium;
  }

  Color _getBorderColor(bool isDarkMode) {
    return isDarkMode ? Colors.white.withValues(alpha: 0.2) : AppColors.borderLight;
  }

  Color _getIconColor(bool isDarkMode) {
    return isDarkMode ? Colors.white.withValues(alpha: 0.8) : AppColors.textDark;
  }

  Color _getContainerColor(bool isDarkMode) {
    return isDarkMode ? Colors.white.withValues(alpha: 0.15) : Colors.white;
  }
