        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white.withValues(alpha: 0.95),
              border: Border(
                left: BorderSide(color: Colors.grey.withValues(alpha: 0.15), width: 1),
              ),
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withValues(alpha: 0.05),
  ...
  Widget _buildChatHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: Colors.blue.withValues(alpha: 0.1), width: 1),
        ),
      ),
      child: Row(
        children: [
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Your intelligent healthcare assistant ready to analyze\nmedical documents and answer your questions',
                ...
                child: Column(
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 12,
                      children: [
                        _buildSuggestionChip('📋 Analyze blood test results'),
                        _buildSuggestionChip('💊 Check medication interactions'),
                        _buildSuggestionChip('📄 Summarize medical reports'),
                        _buildSuggestionChip('🖼️ Analyze X-ray images'),
                      ],
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      'Drag & drop files or use the 📎 button to upload documents',
                      style: GoogleFonts.inter(
                        fontSize: 13,
        ...
        children: [
          ...
          Container(
            ...
            child: IconButton(
              ...
              icon: Icon(Icons.attach_file, color: Colors.grey[700], size: 20),
