                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final double panelWidth = isTablet ? 340 : 380;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildPatientSectionHeader('Allergies & Warnings'),
          const SizedBox(height: 12),
          _buildWarningCard('Drug Allergies', 'Penicillin, Sulfa drugs', Colors.red),
          const SizedBox(height: 8),
  ...
  Widget _buildVitalsTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildPatientSectionHeader('Current Vitals'),
          const SizedBox(height: 12),
          _buildVitalCard('Blood Pressure', '118/76', 'mmHg', Colors.green, MdiIcons.heart),
          const SizedBox(height: 8),
          _buildVitalCard('Heart Rate', '72', 'bpm', Colors.green, MdiIcons.heartPulse),
          const SizedBox(height: 8),
          _buildVitalCard('Temperature', '98.6', '°F', Colors.green, MdiIcons.thermometer),
          const SizedBox(height: 8),
          _buildVitalCard('Oxygen Saturation', '98', '%', Colors.green, MdiIcons.waterPercent),
        ],
      ),
    );
  }
