...
import 'background_l  Widget _buildBarChart() {
    final isDarkMode = Provider.of<AppProvider>(context).isDarkMode;
    return HoverContainer(
      baseColor: isDarkMode ? Colors.black.withValues(alpha: 0.4) : Colors.white.withValues(alpha: 0.9),ut.dart';
...
class _EnhancedAnalyticsPageState extends State<EnhancedAnalyticsPage>
      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return HoverContainer(
              baseColor: isDarkMode ? Colors.black.withValues(alpha: 0.4) : Colors.white.withValues(alpha: 0.9), // Semi-transparent for background image
              borderRadius: BorderRadius.circular(12),
  ...
  Widget _buildLineChart() {
    final isDarkMode = Provider.of<AppProvider>(context).isDarkMode;
    return HoverContainer(
      baseColor: isDarkMode ? Colors.black.withValues(alpha: 0.4) : Colors.white.withValues(alpha: 0.9),
