...
import 'background_                      style: GoogleFonts.inter(
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                        color: isDarkMode ? Colors.white.withValues(alpha: 0.8) : AppColors.textDark,ayout.dart';

class SettingsPanel extends StatefulWidget {
  const SettingsPanel({super.key});

  @override
  State<SettingsPanel> c                decoration: BoxDecoration(
                  color: isDarkMode ? Colors.white.withValues(alpha: 0.15) : Colors.white,ateState() => _SettingsPanelState();
}
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.inter(
                            fontSize: 16,
                            color: isDarkMode ? Colors.white.withValues(alpha: 0.9) : AppColors.textDark,
                          ),
                        ),
                      ],
                    ),
  ...
  Widget _buildSettingsSection(String title, List<Widget> children, bool isDarkMode) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDarkMode ? Colors.white.withValues(alpha: 0.2) : AppColors.borderLight,
          width: 1,
        ),
          ...
          child: Row(
            children: [
              Container(
                ...
                height: 40,
                decoration: BoxDecoration(
                  color: isDarkMode ? Colors.white.withValues(alpha: 0.15) : AppColors.borderLight,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isDarkMode ? Colors.white.withValues(alpha: 0.1) : AppColors.borderLight,
