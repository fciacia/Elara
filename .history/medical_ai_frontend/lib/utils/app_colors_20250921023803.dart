...
class AppColors {
  ...
  // Light Mode - Solid White + Purple + Dark Text
  ...
  static const Color surfaceVariantLight = Color(0xFFFFFFFF); // Pure white variant
  ...
  // Text Colors - Light Mode (Dark text on white backgrounds)
  static const Color textDark = Color(0xFF000000); // Pure black text for maximum contrast
  static const Color textMedium = Color(0xFF374151); // Dark gray text
  static const Color textLight = Color(0xFF4B5563); // Medium gray text for secondary info
  ...
  // Border & Divider Colors - Light Mode (Subtle on white)
  static const Color borderLight = Color(0xFFD1D5DB); // Medium gray border for visibility on white
  static const Color borderLightVariant = Color(0xFFE5E7EB); // Light gray
  static const Color dividerLight = Color(0xFFD1D5DB); // Consistent divider color
