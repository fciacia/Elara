...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          'hello_assist_today': 'Hello! How can I assist you today?',
          'ask_medical_questions': 'Ask medical questions, generate summaries, or request AI-powered insights.',
          'type_prompt_elara': 'Type your prompt for Elara...',
          'ready_to_assist': 'Ready to assist with patient care and medical consultations',
          ...
          'quick_access_protocols': 'Quick access to protocols',
          'patient_search_coming_soon': 'Patient search feature coming soon',
          'emergency_protocols_accessed': 'Emergency protocols accessed',
        ...
        'ms': {
          ...
          'new_chat_session': 'Sesi Sembang Baru',
          'chat_session': 'Sesi Sembang',
          'messages': 'mesej',
          'good_morning': 'Selamat Pagi',
          'good_afternoon': 'Selamat Tengah Hari',
          'good_evening': 'Selamat Petang',
          'hello_assist_today': 'Halo! Bagaimana saya boleh membantu anda hari ini?',
          'ask_medical_questions': 'Tanya soalan perubatan, hasilkan ringkasan, atau minta wawasan berkuasa AI.',
          'type_prompt_elara': 'Taip gesaan anda untuk Elara...',
          'ready_to_assist': 'Bersedia untuk membantu dalam penjagaan pesakit dan konsultasi perubatan',
          'start_ai_consultation': 'Mulakan konsultasi AI',
          'patient_search': 'Carian Pesakit',
          'find_patient_records': 'Cari rekod pesakit',
          'emergency_protocol': 'Protokol Kecemasan',
          'quick_access_protocols': 'Akses pantas ke protokol',
          'patient_search_coming_soon': 'Ciri carian pesakit akan datang',
          'emergency_protocols_accessed': 'Protokol kecemasan diakses',
        ...
        'zh': {
          ...
          'view_all': '查看全部',
          'new_chat_session': '新聊天会话',
          'chat_session': '聊天会话',
          'messages': '条消息',
          'good_morning': '早上好',
          'good_afternoon': '下午好',
          'good_evening': '晚上好',
          'hello_assist_today': '您好！今天我能为您提供什么帮助？',
          'ask_medical_questions': '提出医疗问题、生成摘要或请求AI驱动的洞察。',
          'type_prompt_elara': '为Elara输入您的提示...',
