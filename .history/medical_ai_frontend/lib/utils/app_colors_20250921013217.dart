...
class AppColors {
  ...
  static const Color backgroundLight = Color(0xFFFAFAFA); // Cleaner neutral light background
  static const Color surfaceLight = Color(0xFFFFFFFF);
  static const Color surfaceVariantLight = Color(0xFFF8F7FF); // Subtle purple tint
  ...
  static const Color textDark = Color(0xFF0F0F0F); // Darker for better contrast
  static const Color textMedium = Color(0xFF4A2D5A); // Purple dark
  static const Color textLight = Color(0xFF6B46C1); // More contrast purple
  ...
  static const Color borderLight = Color(0xFFB794F6); // More visible purple border
  static const Color borderLightVariant = Color(0xFFC4B5FD); // Slightly lighter variant
  static const Color dividerLight = Color(0xFFD1C4E9); // Better contrast for dividers
