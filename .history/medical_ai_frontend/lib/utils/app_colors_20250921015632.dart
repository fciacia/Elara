...
class AppColors {
  ...
  static const Color backgroundLight = Color(0xFFFCFCFC); // Pure bright background
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white surfaces
  static const Color surfaceVariantLight = Color(0xFFF7F7F7); // Light gray variant
  ...
  static const Color textDark = Color(0xFF1F2937); // Dark gray text for readability
  static const Color textMedium = Color(0xFF4B5563); // Medium gray text
  static const Color textLight = Color(0xFF6B7280); // Light gray text for secondary info
  ...
  // Border & Divider Colors - Light Mode (Neutral, not purple)
  static const Color borderLight = Color(0xFFE5E7EB); // Light gray border
  static const Color borderLightVariant = Color(0xFFF3F4F6); // Very light gray
  static const Color dividerLight = Color(0xFFE5E7EB); // Consistent divider color
