    ...
    return Align(
      ...
      child: TextButton(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('forgot_password_coming_soon'.tr),
              behavior: SnackBarBehavior.floating,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
            ),
          );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildDemoAccount('sarah.ahmad@hospital.my', 'doctor_account'.tr, Colors.blue),
          _buildDemoAccount('ahmad.ali@email.com', 'nurse_account'.tr, Colors.pink),
          _buildDemoAccount('admin@hospital.my', 'admin_account'.tr, Colors.purple),
          const SizedBox(height: 12),
          Container(
