...
class ChatProvider extends ChangeNotifier {
  ...
  final Map<UserRole, List<String>> _demoResponses = {
    UserRole.nurse: [
      "Patient vitals are stable. Blood pressure: 120/80, Temperature: 98.6°F. Continue monitoring every 4 hours.",
    ...
    _chatSessions = [
      ChatSession(
        ...
        messages: [
          ...
          ChatMessage(
            id: '1-2',
            content: 'Based on your blood test results from March 2024, your hemoglobin level is 14.2 g/dL, which is within the normal range for adults. Your white blood cell count is also normal at 7,200/μL, indicating no signs of infection or immune system issues.',
